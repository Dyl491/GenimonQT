...
namespace {
struct qt_meta_tag_ZN5PauseE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN5PauseE = QtMocHelpers::stringData(
    "Pause"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN5PauseE[] = {
...
Q_CONSTINIT const QMetaObject Pause::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5PauseE.offsetsAndSizes,
    qt_meta_data_ZN5PauseE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5PauseE_t,
        // Q_OBJECT / Q_GADGET
...
void *Pause::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5PauseE.stringdata0))
