...
static constexpr auto qt_meta_stringdata_ZN8CommandeE = QtMocHelpers::stringData(
    "Commande",
    "on_Retour_clicked",
    "",
    "checked",
...
Q_CONSTINIT static const uint qt_meta_data_ZN8CommandeE[] = {
...
Q_CONSTINIT const QMetaObject Commande::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8CommandeE.offsetsAndSizes,
    qt_meta_data_ZN8CommandeE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8CommandeE_t,
        // Q_OBJECT / Q_GADGET
...
void Commande::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onDataReceived((*reinterpret_cast< std::add_pointer_t<QJsonObject>>(_a[1]))); break;
...
void *Commande::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8CommandeE.stringdata0))
