...
namespace {
struct qt_meta_tag_ZN7GenidexE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN7GenidexE = QtMocHelpers::stringData(
    "Genidex"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7GenidexE[] = {
...
Q_CONSTINIT const QMetaObject Genidex::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7GenidexE.offsetsAndSizes,
    qt_meta_data_ZN7GenidexE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7GenidexE_t,
        // Q_OBJECT / Q_GADGET
...
void *Genidex::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7GenidexE.stringdata0))
