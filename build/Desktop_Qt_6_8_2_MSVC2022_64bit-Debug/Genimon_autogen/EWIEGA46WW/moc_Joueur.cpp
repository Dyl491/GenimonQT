...
namespace {
struct qt_meta_tag_ZN6JoueurE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN6JoueurE = QtMocHelpers::stringData(
    "Joueur"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN6JoueurE[] = {
...
Q_CONSTINIT const QMetaObject Joueur::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6JoueurE.offsetsAndSizes,
    qt_meta_data_ZN6JoueurE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6JoueurE_t,
        // Q_OBJECT / Q_GADGET
...
void *Joueur::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6JoueurE.stringdata0))
