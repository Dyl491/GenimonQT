...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        Commande = new QPushButton(centralwidget);
        ...
        Commande->setPalette(palette5);
        Combat = new QPushButton(centralwidget);
        Combat->setObjectName("Combat");
        Combat->setGeometry(QRect(1010, 420, 150, 40));
        QPalette palette6;
        ...
        Combat->setPalette(palette6);
        Combat->setMouseTracking(false);
        Combat->setAutoFillBackground(false);
        Combat->setIconSize(QSize(20, 20));
        Combat->setCheckable(false);
        Genidex = new QPushButton(centralwidget);
        Genidex->setObjectName("Genidex");
        Genidex->setGeometry(QRect(1010, 480, 150, 40));
        QPalette palette7;
        ...
        Genidex->setPalette(palette7);
        Genidex->setMouseTracking(false);
        Genidex->setAutoFillBackground(false);
        Genidex->setIconSize(QSize(20, 20));
        Genidex->setCheckable(false);
        Historencontre = new QPushButton(centralwidget);
        Historencontre->setObjectName("Historencontre");
        Historencontre->setGeometry(QRect(1010, 540, 150, 40));
        QPalette palette8;
        ...
        Historencontre->setPalette(palette8);
        Historencontre->setMouseTracking(false);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        Commande->setText(QCoreApplication::translate("MainWindow", "Commande", nullptr));
